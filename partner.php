                            ...
                            <table id="" class="data-table table">
                                ...
                                foreach (getAllDistributeur() as $user)
                                {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="row">
                                                <button   title="Vente de crédit." data-toggle="tooltip" data-placement="right"  onclick="viewData('<?php echo infos_user($id)->nom." ".infos_user($id)->prenom; ?>', '<?php echo $id; ?>')"  style="width: 2em;height: 2em;margin-right: 7px;" class="sa-info btn btn-dark btn--icon"><i class="zmdi zmdi-local-gas-station"></i></button>

                                                <div class="form-group">
                                                    <div style="height: 9px" class="toggle-switch toggle-switch--green">
                                                        <input id="id<?php  echo $id; ?>" onchange="myChange('<?php echo $id; ?>')"  <?php if(findDistributeur($id) == true){echo "checked";}else{ echo ""; } ?> type="checkbox" class="chek toggle-switch__checkbox" >
